...
function ControlFlowGraph(astNode) {
	...
	function expressionThrows(astNode) {
		// Null is checked for the case where there are null astNodes
		// example: const [, b, c] = [1, 2, 3];
		if (astNode === null || typeof astNode !== 'object' || 'FunctionExpression' === astNode.type)
			return false;
